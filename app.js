...
const mainMotivationQuote = document.getElementById("mainMotivationQuote");
...
function setTheme(theme) {
    ...
    document.body.classList.remove("theme-rainbow", "theme-hearts", "theme-dots", "theme-lines");
...
function displayRandomQuote() {
    ...
    if (mainMotivationQuote) {
        mainMotivationQuote.textContent = randomQuote;
    }
}
...
function renderNotes() {
    ...
    notes.forEach((note, index) => {
        ...
        const reactionButtons = `
            <button class="reaction-btn ${reactions.happy ? 'active' : ''}" data-note-index="${index}" data-reaction="happy">
                😊 Happy
            </button>
            <button class="reaction-btn ${reactions.sad ? 'active' : ''}" data-note-index="${index}" data-reaction="sad">
                😢 Sad
            </button>
            <button class="reaction-btn ${reactions.excited ? 'active' : ''}" data-note-index="${index}" data-reaction="excited">
                🤩 Excited
            </button>
            <button class="reaction-btn ${reactions.love ? 'active' : ''}" data-note-index="${index}" data-reaction="love">
                ❤️ Love
            </button>
            <button class="reaction-btn ${reactions.angry ? 'active' : ''}" data-note-index="${index}" data-reaction="angry">
                😡 Angry
            </button>
        `;
        ...
        noteDiv.innerHTML = `
            ...
            <div class="note-reactions">
                ${reactionButtons}
                <button class="note-delete" data-note-index="${index}">
...
// HANDLE NOTE REACTIONS AND DELETE
notesList.addEventListener("click", (e) => {
    const noteIndex = e.target.closest("[data-note-index]")?.dataset.noteIndex;
    ...
    if (e.target.closest(".reaction-btn")) {
        ...
        notes[index].reactions[reaction] = !notes[index].reactions[reaction];
        saveNotes();
        renderNotes();
    }
...
function loadNotes() {
    let saved = localStorage.getItem("notesApp");
    if (saved) {
